	...
	public ForcePos() {
		...
		JPanel background = new JPanel() {
			...
			public void paintComponent(Graphics g) {
				...
				ImageIcon image = new ImageIcon(
						"\\home\\ahn\\eclipse-workspace\\POS2\\src\\image\\loginBackground.png"); // 이미지얻어옴.
		...
		JPanel title = new JPanel() {
			protected void paintComponent(Graphics g) {
				Dimension d = getSize();
				ImageIcon image = new ImageIcon("\\home\\ahn\\eclipse-workspace\\POS2\\src\\image\\LoginTitle.png");
		...
		userTf = new JTextField(6) {
			...
			protected void paintComponent(Graphics g) {
				Dimension d = getSize();
				ImageIcon image = new ImageIcon("home\\ahn\\eclipse-workspace\\POS2\\src\\image\\idbg.png");
				g.drawImage(image.getImage(), 0, 0, d.width, d.height, null);
				setOpaque(false);
				super.paintComponent(g);
			};
		...
		passTf = new JPasswordField(6) {
			...
			protected void paintComponent(Graphics g) {
				Dimension d = getSize();
				ImageIcon image = new ImageIcon("\\home\\ahn\\eclipse-workspace\\POS2\\src\\image\\pwbg.png");
				g.drawImage(image.getImage(), 0, 0, d.width, d.height, null);
				setOpaque(false);
				super.paintComponent(g);
			};
